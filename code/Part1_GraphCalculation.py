# Requires being in conda environment 'graphs' (graph_env.yml)
# conda create -f graph_env.yml
# 'type: ignore' added for VSCode problem flags
...
if __name__ == "__main__":
    ...
    results = Parallel(n_jobs=num_cores)(delayed(loop_iter)(row) for _, row in fc_list.iterrows())
    ...
    sign_cols = ["sub_id","avg_weight"] + pc_cols + cc_cols + network_fc_cols + wfc_cols + bfc_cols
